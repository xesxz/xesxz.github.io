...
</code></pre></div><h2 id="tomcat" tabindex="-1"><a class="header-anchor" href="#tomcat" aria-hidden="true">#</a> Tomcat</h2>`,10),i={href:"https://www.jianshu.com/p/69496fb3495e",target:"_blank",rel:"noopener noreferrer"},h=n("MAC \u4E0B\u5B89\u88C5\u914D\u7F6E Tomcat\uFF08\u5C0F\u767D\u5411\uFF09"),u=s(`<div class="language-text ext-text"><pre class="language-text"><code>cd /Library/Tomcat/bin
sudo sh ./startup.sh
sudo sh ./shutdown.sh
...
</code></pre></div>`,9),m={href:"https://blog.csdn.net/bangshabgni/article/details/131038760",target:"_blank",rel:"noopener noreferrer"},_=n("debian \u7AEF\u53E3\u5F00\u542F"),x=e("p",null,"linux\u67E5\u770B\u67B6\u6784 uname -a",-1),f=e("p",null,"ip addr show eth0",-1),g={href:"https://blog.csdn.net/lym003/article/details/1337696",target:"_blank",rel:"noopener noreferrer"},b=n("Debian12"),w=s(`<div class="language-text ext-text"><pre class="language-text"><code>sudo apt update
wget https://dev.mysql.com/get/mysql-apt-config_0.8.25-1_all.deb
sudo dpkg -i mysql-apt-config_0.8.25-1_all.deb
</code></pre></div><p>sudo apt-get update sudo apt-get install mlocate</p><p>sudo updatedb</p><p>locate -b &#39;\\example_folder&#39;</p><p>curl wget</p><p>vi 1\u3001\u4F7F\u7528\u201C:wq\u201D\u6216\u201C:x\u201D\u6216\u201CZZ\u201D\u547D\u4EE4\u5373\u53EF\u4FDD\u5B58\u9000\u51FA\uFF1B2\u3001\u4F7F\u7528\u201C:q\u201D\u547D\u4EE4\u5373\u53EF\u6B63\u5E38\u9000\u51FA\uFF1B\u4F7F\u7528\u201C:q!\u201D\u5373\u53EF\u4E0D\u4FDD\u5B58\u9000\u51FA\uFF1B4\u3001\u4F7F\u7528\u201C:!\u201D\u5373\u53EF\u5F3A\u5236\u9000\u51FA</p><p>vim</p><p>:w - \u4FDD\u5B58\u6587\u4EF6\uFF0C\u4E0D\u9000\u51FA vim</p><p>:w file -\u5C06\u4FEE\u6539\u53E6\u5916\u4FDD\u5B58\u5230 file \u4E2D\uFF0C\u4E0D\u9000\u51FA vim</p><p>:w! -\u5F3A\u5236\u4FDD\u5B58\uFF0C\u4E0D\u9000\u51FA vim</p><p>:wq -\u4FDD\u5B58\u6587\u4EF6\uFF0C\u9000\u51FA vim</p><p>:wq! -\u5F3A\u5236\u4FDD\u5B58\u6587\u4EF6\uFF0C\u9000\u51FA vim</p><p>:q -\u4E0D\u4FDD\u5B58\u6587\u4EF6\uFF0C\u9000\u51FA vim</p><p>:q! -\u4E0D\u4FDD\u5B58\u6587\u4EF6\uFF0C\u5F3A\u5236\u9000\u51FA vim</p><p>:e! -\u653E\u5F03\u6240\u6709\u4FEE\u6539\uFF0C\u4ECE\u4E0A\u6B21\u4FDD\u5B58\u6587\u4EF6\u5F00\u59CB\u518D\u7F16\u8F91</p><p>apt install</p><p>&#39;root&#39;@&#39;localhost&#39; IDENTIFIED WITH caching_sha2_password BY &#39;5461150&#39;; use mysql;</p><p>update user set host = &#39;%&#39; where user = &#39;root&#39;;</p><p>cp -r /etc/ssh/dist{,.bak} cp /path/to/your/index.html{,.bak} cp /etc/ssh/sshd_config{,.bak}</p><p>debian10 \u81EA\u5E26wget</p><p>sudo lsof -i -P -n \u67E5\u770B\u6240\u6709\u7AEF\u53E3</p><p>lsof -i:\u7AEF\u53E3\u53F7</p><p>netstat -ntlp</p><p>https://233boy.com/v2ray/v2ray-server/</p><p>systemctl stop firewalld; systemctl disable firewalld; ufw disable \u5173\u95ED\u9632\u706B\u5899</p>`,25);function v(k,y){const t=p("ExternalLinkIcon");return l(),d("div",null,[r,e("p",null,[e("a",i,[h,a(t)])]),u,e("p",null,[e("a",m,[_,a(t)])]),x,f,e("p",null,[e("a",g,[b,a(t)])]),w])}var I=o(c,[["render",v],["__file","linux.html.vue"]]);export{I as default};
